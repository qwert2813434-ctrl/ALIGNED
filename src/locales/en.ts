...
export const en: Record<string, string> = {
  ...
  "目前顏色套到全部筆畫": "Apply current colour to all strokes",
  "目前筆寬套到全部筆畫": "Apply current width to all strokes",
  "目前筆刷套到全部筆畫": "Apply current brush to all strokes",
  "色票": "Palette",
  "深淺": "Tints & shades",
  "標準色": "Standard",
  "灰階": "Greys",
  "任何顏色…": "Any colour…",
  "溝寬會等比跟著；要單獨調溝寬用下一列": "Gutter scales along; use the next row to set it alone",
  "檔案（新專案・開啟・存檔・範本・打包）": "File (new, open, save, template, package)",
  "新專案": "New project",
  "開啟…": "Open…",
  "存檔": "Save",
  "打包 .alignproj（含素材，iPad 可開）": "Package .alignproj (with assets, opens on iPad)",
  "調整框內畫面": "Adjust photo in frame",
  "雙擊": "Double-click",
  ...
  "油墨濃度": "Ink density",
  "紙張顆粒": "Paper grain",
  "✓ 專案封面（首頁縮圖）": "✓ Project cover (home thumbnail)",
  "設為專案封面（首頁縮圖）": "Set as project cover (home thumbnail)",
  "專案封面＝第 {n} 頁": "Project cover = page {n}",
  "貼紙邊": "Sticker edge",
  "加上": "Add",
  "立體感": "Emboss",
  "撕紙邊": "Torn edge",
  ...
  // ── 文字庫（2026-09-14，字眼跟 iOS 文字庫同一套英譯）──
  "文字庫": "Text Library",
  "文字庫（寫稿、收文字、排進畫面）": "Text Library (write, collect, place on page)",
  "寫新的一篇": "New Text",
  "搜尋文字": "Search Text",
  "標題（可不填）": "Title (optional)",
  "寫": "Write",
  "稿紙": "Grid",
  "拷貝全文": "Copy All",
  "已拷貝": "Copied",
  ...
  "已排進 {n} 次": "Placed: {n}",
  "排進畫面": "Place on Page",
  "已排進第 {n} 頁": "Placed on page {n}",
  "未命名": "Untitled",
  "還沒有文字": "No Text Yet",
  "想法先放這裡，不一定要排進版面。按右上角寫第一篇。": "Keep ideas here—they don't have to go into a layout. Use the button at the top right to write your first one.",
  "沒有符合的文字": "No matching text",
  "選左邊一篇來看，或按「寫新的一篇」。": "Pick a text on the left, or choose New Text.",
  "先在「寫」打字，這裡會照每排格數排出來": "Type in Write first—this grid lays it out by characters per row.",
  "減少": "Decrease",
  "增加": "Increase",
  "衝突副本": "Conflict Copy",
  "收進文字庫": "Add to Text Library",
  "收進 {n} 篇到文字庫": "Added {n} to Text Library",
  "收進 {n} 篇，{m} 篇本來就在文字庫": "Added {n}; {m} already in Text Library",
  "都已經在文字庫裡了": "Already in Text Library",
  "收進文字庫失敗：{msg}": "Couldn't add to Text Library: {msg}",
  "先選好文字庫的位置，再收一次": "Choose a Text Library folder first, then add again",
  "找不到文字庫資料夾": "Text Library folder not found",
  "iPhone、iPad 在「設定 › 傳輸資料夾」選的位置裡會有 TextLibrary。這台選同一個位置，就會看到同一批文字。": "On iPhone and iPad, the Transfer Folder chosen in Settings contains a TextLibrary folder. Choose the same place here to see the same texts.",
  "在 iCloud 雲碟建立 ALIGNED 資料夾": "Create ALIGNED Folder in iCloud Drive",
  "選資料夾…": "Choose Folder…",
  "換位置…": "Change Location…",
  "改回自動找 iCloud 雲碟": "Find in iCloud Drive Automatically",
  "選文字庫資料夾": "Choose Text Library Folder",
  "讀不到文字庫資料夾：{msg}": "Can't read the Text Library folder: {msg}",
  "iCloud 雲碟": "iCloud Drive",
  "{n} 篇": "{n} texts",
  "還有 {n} 篇在 iCloud 下載中": "{n} more downloading from iCloud",
  "另一台也改了這篇，對方的版本另存成「{name}」": "This text also changed on another device; that version was saved as “{name}”.",
  "另一台的版本比較新，已換成那一份；你剛打的另存成「{name}」": "Another device has a newer version, shown here now; your edits were saved as “{name}”.",
  "這篇在別台被刪掉了": "This text was deleted on another device.",
